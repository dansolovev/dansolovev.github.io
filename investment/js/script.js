function myFunction() {
    ...
    {   
        ...
        if ($(".promo__header").length){
          ...
          $('.promo__wrapper').append("<div class='promo__header'><h1 class='subheading p-h'>Хватит терять деньги на фондовом рынке - пришло время их зарабатывать!</h1><img src='img/promo.png' alt='promo' class='promo__img'><div class='fz16 descr'>Я дам вам то, чему научился <br> сам за много лет. <br> Дам вам то, чего не даст вам ни один «коуч»</div><div class='fz16 descr'>Вы меня знаете - никакого обмана</div><div class='btn btn_t btn_promo'>Button</div><div class='fz16 descr'>Это уникальный шанс для каждого <br> из вас начать разбираться <br> в акциях и научиться их <br> анализировать!</div></div>");
        }

        if ($(".to-whom__img").length){
        }
        else {
          $('.to-whom_subheading').after("<img src='img/to-whom.png' alt='to-whom' class='to-whom__img'>");
        }
        ...
        if ($(".what__img").length){
          ...
          $('.what_subheading').after("<img src='img/what.png' alt='what' class='what__img'>");
        }
        ...
        if ($(".themes__img").length){
          ...
          $('.themes_subheading').after("<div class='themes__img'><img src='img/themes.png' alt='themes' class='themes__img'></div>");
        }
        ...
        if ($(".whyus__img").length){
          ...
          $('.whyus_subheading').after("<img src='img/whyus.png' alt='whyus' class='whyus__img'>");
        }
        ...
        if ($(".faq__img").length){
          ...
          $('.faq_subheading').after("<div class='faq__img'><img src='img/faq.png' alt='faq' class='faq__img'></div>");
        }
